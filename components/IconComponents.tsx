...
export const AlbumIcon: React.FC<{ className?: string }> = ({ className }) => (
...
export const MagnetIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M15 4h- presenza.83a2 2 0 0 0-1.79 1.11l-1.17 2.33a2 2 0 0 1-1.79 1.11H4a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2h4.21a2 2 0 0 1 1.79 1.11l1.17 2.33a2 2 0 0 0 1.79 1.11H15a2 2 0 0 0 2-2v-4a8 8 0 0 0-8-8V4a2 2 0 0 0-2-2z"></path>
    <path d="M19 8l-4 4"></path><path d="m19 12-4-4"></path>
  </svg>
);
...
export const FrameIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <rect width="18" height="18" x="3" y="3" rx="2" ry="2"></rect>
    <rect width="10" height="10" x="7" y="7" rx="2" ry="2"></rect>
  </svg>
);
...
export const GiftCardIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <rect x="2" y="7" width="20" height="13" rx="2"></rect>
    <path d="M2 10h20"></path>
    <path d="M7 15h2"></path><path d="M15 15h2"></path>
    <path d="m17.5 7.5-3-3"></path><path d="m6.5 7.5 3-3"></path>
  </svg>
);
